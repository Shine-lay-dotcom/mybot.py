...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8628986145:AAGMrNEKBZVhA9S-rlbhRUs7vkLqKj9Jiyc")
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN", "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")
REPO_OWNER = os.getenv("REPO_OWNER", "Shine-lay-dotcom")
REPO_NAME = os.getenv("REPO_NAME", "Mybot.py")
ADMIN_ID = os.getenv("ADMIN_ID", "7074774446")
